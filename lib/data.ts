...
export const SERVICES: Service[] = [
  {
    ...
    title: "Trade Shows",
    description:
      "High-impact booth design and fabrication that commands attention on the exhibition floor.",
  ...
  },
  {
    ...
    description:
      "End-to-end event production that reflects your brand's stature and vision.",
  ...
  },
  {
    ...
    title: "Conferences",
    description:
      "Thoughtful spatial design and logistics for conferences that inspire and connect.",
  ...
  },
  {
    ...
    description:
      "Seamless planning and execution from concept to teardown, every time.",
  ...
  },
  {
    ...
    description:
      "Full-cycle exhibition management for domestic and international shows.",
  ...
  },
  {
    ...
    description:
      "Custom, award-worthy exhibition design that tells your brand story spatially.",
  ...
  },
  {
    ...
    description:
      "Strategic on-ground promotions that build awareness and drive conversion.",
  ...
  },
  {
    ...
    description:
      "Memorable launch events that generate buzz, coverage, and lasting impressions.",
  ...
  },
  {
    ...
    description:
      "Immersive, interactive experiences that forge genuine human-brand connections.",
  ...
  },
  {
    ...
    description:
      "Elegant, prestigious ceremonies that celebrate achievement with gravitas.",
  ...
  },
  {
    ...
    title: "Decor & Concept",
    description:
      "Bespoke décor and conceptual design that transforms any space into an experience.",
  ...
  },
  {
    ...
    title: "Road Shows",
    description:
      "Multi-city roadshows that carry your brand narrative across geographies.",
...
export const CORE_VALUES: CoreValue[] = [
  {
    ...
    description:
      "We hold ourselves to a standard that goes beyond client expectations. Mediocrity is not an option — in concept, craft, or delivery.",
  ...
  },
  {
    ...
    description:
      "Every decision — spatial, material, experiential — is filtered through the lens of design thinking. Beauty and function are never at odds.",
  ...
  },
  {
    ...
    description:
      "We communicate honestly about timelines, budgets, and limitations. Trust is the foundation of every long-term partnership we build.",
  ...
  },
  {
    ...
    description:
      "We are mindful of the materials we use, the waste we generate, and the communities we work within. Creating beautifully means creating responsibly.",
...
export const PROJECTS: Project[] = [
  {
    ...
    description:
      "A textile heritage experience that brought the art of weaving to life through spatial narrative.",
    colorFrom: "#0E516D",
    colorTo: "#1a7fa0",
  ...
  },
  {
    ...
    description:
      "A high-energy brand activation that positioned AB Collections at the forefront of fashion retail.",
    colorFrom: "#2c3e50",
    colorTo: "#0E516D",
  ...
  },
  {
    ...
    category: "Trade Show",
    description:
      "An immersive country pavilion that transported visitors to the landscapes and culture of Azerbaijan.",
    colorFrom: "#1a5276",
    colorTo: "#2e86c1",
  ...
  },
  {
    ...
    description:
      "Precision-engineered event identity for an Italian industrial food-tech brand entering India.",
    colorFrom: "#0a3d53",
    colorTo: "#0E516D",
  ...
  },
  {
    ...
    description:
      "A commanding product launch environment that set a new benchmark for agricultural innovation.",
    colorFrom: "#17618a",
    colorTo: "#0a3d53",
  ...
  },
  {
    ...
    description:
      "Grassroots brand promotions and activations that built deep community affinity.",
    colorFrom: "#0E516D",
    colorTo: "#073a50",
...
export const CLIENTS: ClientLogo[] = [
  ...
  { name: "Makino", logoUrl: "https://logo.clearbit.com/makino.com" },
  {
    ...
    logoUrl: "https://logo.clearbit.com/metrochem.co.in",
  },
  {
    name: "Power Plus Store",
    logoUrl: "https://logo.clearbit.com/powerplus.com",
  },
  {
    name: "Paris Premium",
    logoUrl: "https://logo.clearbit.com/parispremium.com",
  },
  ...
  { name: "Caterpillar", logoUrl: "https://logo.clearbit.com/caterpillar.com" },
  {
    ...
    logoUrl: "https://logo.clearbit.com/amritahospitals.org",
  },
  ...
  {
    name: "WC Creations",
    logoUrl: "https://logo.clearbit.com/wccreations.com",
  },
  {
    name: "Jaquet Technology Group",
    logoUrl: "https://logo.clearbit.com/jaquet.com",
  },
  ...
  {
    name: "Herman Hansen Norway",
    logoUrl: "https://logo.clearbit.com/akersolutions.com",
  },
  { name: "EESL", logoUrl: "https://logo.clearbit.com/eeslindia.co.in" },
  {
    name: "Indo Farm Equipment",
    logoUrl: "https://logo.clearbit.com/indofarm.co.in",
  },
];
