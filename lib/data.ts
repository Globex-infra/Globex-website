...
export const PROCESS_STEPS: ProcessStep[] = [
  {
    ...
    description: "We begin by deeply understanding your brand narrative, target audience, and objectives. Through collaborative workshops and research, we uncover the insights that will shape your experience.",
  },
  {
    id: 2,
    number: "02",
    title: "Impact & Measurement",
    description: "We don't stop at opening day. We measure engagement, gather feedback, and analyze the impact of your experience to ensure lasting results and continuous improvement.",
  },
  {
    id: 3,
    number: "03",
    title: "Creative Conceptualization",
    description: "Our creative team transforms insights into compelling spatial concepts. We explore innovative ideas, push boundaries, and develop designs that are both visually striking and strategically aligned.",
  },
  {
    id: 4,
    number: "04",
    title: "Concepts",
    description: "From detailed planning to flawless execution, we manage every aspect with precision. Our team coordinates vendors, oversees quality, and ensures your vision comes to life exactly as imagined.",
  },
  {
    id: 5,
    number: "05",
...
export const CLIENTS: ClientLogo[] = [
  ...
  { name: "Metrochem API Private Limited", logoUrl: "https://logo.clearbit.com/metrochem.co.in" },
